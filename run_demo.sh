...
if [ ! -f "mail/test_mail_all_students.py" ]; then
    print_error "mail/test_mail_all_students.py not found"
    exit 1
fi

print_status "Test script found: mail/test_mail_all_students.py"
